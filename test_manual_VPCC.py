...
def parse_args():
    ...
    parser.add_argument('--arch', type=str, default='SSIU_VPCC', help='which network')
    parser.add_argument('--log_path', type=str, default='./logs_test/2023/SSIU_VPCC/')
    ...
    parser.add_argument('--data_path', type=str, default='./dataset_creat/data_ori_test_VPCC/testFile.txt')
    parser.add_argument('--pretrain_Y', type=str, default='./pths/2023/SSIU_VPCC/Y/2023-09-23/R0'+c+'_SSIU_Net/model_5.pth')
    parser.add_argument('--pretrain_U', type=str, default='./pths/2023/SSIU_VPCC/U/2023-09-23/R0'+c+'_SSIU_Net/model_24.pth')
    parser.add_argument('--pretrain_V', type=str, default='./pths/2023/SSIU_VPCC/V/2023-09-23/R0'+c+'_SSIU_Net/model_45.pth')
    parser.add_argument('--ori_path', type=str, default='./dataset_creat/data_ori_test_VPCC/')
    parser.add_argument('--rec_path', type=str, default='./dataset_creat/data_rec_test_VPCC/')
    parser.add_argument('--pred_path', type=str, default='./data/preds/2023/SSIU_VPCC/VPCC_r0'+c+'_WPCSD/')
    parser.add_argument('--notes', type=str, default='VPCC_r0'+c+'_YUV_WPCSD')
...
def main(opt):
    ...
    textfile_name = str(datetime.datetime.now().strftime('%Y-%m-%d_%H-%M')) + '_test_VPCC.txt'
    ...
    with open(opt.data_path, "r") as f:
        for line in f.readlines():
            ...
            if os.path.splitext(line)[1] == ".ply":
                pointcloud_ori = read_ply(os.path.join(opt.ori_path, os.path.splitext(line)[0]+'_r0'+c+'.ply'))  # [numpoint, 6]
                ...
                filepath = os.path.join(opt.pred_path, line)
